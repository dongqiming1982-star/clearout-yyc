...
function getRoute(): Route {
  ...
  if (p === '/aurora') return { type: 'aurora' }
...
function applySeo(route: Route, lang: Lang) {
  if (route.type === 'aurora') {
    document.title = 'Aurora Site Solutions | Local Digital Systems'
    upsertMeta('description', 'Aurora Site Solutions operates lightweight local digital systems, including Clearout YYC, a Calgary junk removal request platform.')
    upsertCanonical('/aurora')
    return
  }
...
function isAuroraOperatorHost() {
  const host = window.location.hostname.toLowerCase()
  return host === 'www.aurorasitesolutions.com' || host === 'aurorasitesolutions.com'
}
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (auroraHost) {
      ...
      el.setAttribute('href', 'https://www.aurorasitesolutions.com/')
      removeJsonLd('clearout-yyc-structured-data')
      return
    }
    applySeo(route, lang)
